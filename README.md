...
* [Try it out](http://18.216.12.121/careerWise/)
   * username: 1234
   * password: 1234
   * Known issue: I am using a free plan of `MonkeyLearn`, sometimes the quote is out of 300/month limit and query function will down (got 500 Error).
...
* [AWS (RDS+EC2)](http://aws.amazon.com)
